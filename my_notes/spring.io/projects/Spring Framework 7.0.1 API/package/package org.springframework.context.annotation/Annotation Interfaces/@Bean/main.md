[text](https://docs.spring.io/spring-framework/docs/7.0.1/javadoc-api/org/springframework/context/annotation/Bean.html)
...
Profile, Scope, Lazy, DependsOn, Primary, Order Link icon
...
@Bean Methods in @Configuration Classes Link icon
...
BeanFactoryPostProcessor-returning @Bean methods Link icon
